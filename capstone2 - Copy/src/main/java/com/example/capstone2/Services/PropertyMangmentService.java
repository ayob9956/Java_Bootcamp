...
public class PropertyMangmentService {
    ...
    public void addBulding(PropertyMangment propertyMangment, User user) {

        propertyMangment.setUser(user);
        propertyMangmentRepostry.save(propertyMangment);
    }

    public void updateProperty(Integer id, PropertyMangment propertyMangment) {
        PropertyMangment propertyMangment1 = propertyMangmentRepostry.findPropertyMangmentById(id);
        ...
        propertyMangment1.setExpectedincome(propertyMangment.getExpectedincome());
        propertyMangment1.setPrice(propertyMangment.getPrice());
