...
public class PropertyMangmentController {
    ...
    @PostMapping("/add")
    public ResponseEntity addedProperty(@RequestBody @Valid PropertyMangment propertyMangment, @AuthenticationPrincipal User user){

        propertyMangmentService.addBulding(propertyMangment,user);
